        ...
        <div class="row">
            <div class="col-md-7">
                <div class="wed-book">
                    ...
                    <form  method="post" action="{{action('User\EventBookController@store')}}">
                        @csrf
                        ...
                        <div class="row">
                           ...
                           @endif
                            ...
                            <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text"onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"  placeholder="Name" class="form-control input-md">
                                </div>
                            </div>
                            <!-- Text input-->
                            <div class="col-md-6">
                          ...
                          {{-- <div class="col-md-6">
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="time">Packages</label>
                                    <select id="time" name="package_name" class="form-control">
                                        <option value="">Select a  Name</option>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control my-2" type="datetime-local" name="time_date" value="2021-03-18T16:00" required>
                        </div>
                        </div>
                            {{-- <div class="col-md-12">
                                <div class="form-group">
