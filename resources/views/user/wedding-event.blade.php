...
@section('content')
<div class="contact-main-area bg h-400" style="background-image: url('{{asset('public/user_asset/asset')}}/image/normalvenue5.jpg')">
    <div class="container">
        ...
        <div class="brth-content text-center">
            ...
            <div class="brth-main py-5">
                <div class="brth-single-content">
                    <img src="{{asset('public/user_asset/asset')}}/image/service/w1.png" alt="" width="300px">
                </div>
                <div class="brth-single-content">
...
<div class="brth-booking-area bg  pt-100 pb-100" style="background-image: url('{{asset('public/user_asset/asset')}}/image/portfolio/weddingphotography7.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <h1 class="yellow pb-5">We make your events smart & impactful by personalised event management services</h1>
                <a href="#booked">
                <button class="btn btn btn-warning">Book Appointment</button>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row pt-100 h-400">
            <div class="col-md-6 py-5">
                <h1 class="red py-3">BEST VENUE</h1>
        ...
        <div class="row pb-100 h-400">
            ...
            <div class="col-md-6 py-5">
                <h1 class="yellow py-3">CREATE BEST SCEANE THAT YOU CAN MEMORIZE!</h1>
                <p class="pb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit reiciendis praesentium suscipit fugit. Perferendis cumque facilis magnam asperiores veniam nostrum accusantium repellendus voluptatum laboriosam error. Qui rerum nostrum ex provident!</p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="wed-book">
                    ...
                    <form  method="post" action="{{action('User\WeddingBookController@store')}}">
                        @csrf
                            ...
                            <!-- Text input-->            
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control my-2" type="datetime-local" name="start" value="2021-03-18T10:00"> 
                                    </div>
                                </div>
