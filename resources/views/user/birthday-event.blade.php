...
@section('content')
<div class="contact-main-area bg h-400" style="background-image: url('{{asset('public/user_asset/asset')}}/image/birthdayhall1.jpg')">
    <div class="container">
...
<div class="brth-main-area pt-100">
    <div class="container">
        <div class="brth-content text-center">           
            <div class="brth-main py-5">
                <div class="brth-single-content">
                    <img src="{{asset('public/user_asset/asset')}}/image/service/balloon.png" alt="" width="300px">
                </div>
                <div class="brth-single-content">
                    <h1 class="red subtitle2 mb-3 text-left">Choose as you want</h1>
...
<div class="brth-booking-area bg  pt-100 pb-100" style="background-image: url('{{asset('public/user_asset/asset')}}/image/birthdayhall3.jpg')">
    <div class="container">
        <div class="col-md-12">
            <h1 class="yellow pb-5">We make your events smart & impactful by personalised event management services</h1>
            <a href="#booked"> <button class="btn btn btn-warning">Book Appointment</button>
            </a>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row pt-100 h-400">
            <div class="col-md-6 py-5">
                <h1 class="red py-3">FAMILY CELEBRATION</h1>
            ...
            <div class="col-md-6 bg" style="background-image: url('{{asset('public/user_asset/asset')}}/image/eventstoryimg8.jpg" alt="">
            </div>
        </div>
        <div class="row pb-100 h-400">
            <div class="col-md-6 bg" style="background-image: url('{{asset('public/user_asset/asset')}}/image/birthdayhall5.jpg" alt="">

            </div>
            <div class="col-md-6 py-5">
                <h1 class="yellow py-3">FRIENDS CELEBRATION!</h1>
                <p class="pb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit reiciendis praesentium suscipit fugit. Perferendis cumque facilis magnam asperiores veniam nostrum accusantium repellendus voluptatum laboriosam error. Qui rerum nostrum ex provident!</p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="wed-book">
                    ...
                    <form  method="post" action="{{action('User\BirthdayBookController@store')}}">
                        @csrf
