...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card card-statistics">
            ...
            <div class="card-body">
                <form method="post" action="{{action('Admin\PhotographyController@store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" aria-describedby="emailHelp" placeholder="Enter location">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="experience" aria-describedby="emailHelp" placeholder="Enter experience">
                    </div>
