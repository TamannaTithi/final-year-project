    ...
    <div class="col-md-3 col-sm-6">
        <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-white text-center">{{$photographer->name}}</h3>

              <p class="text-muted text-center">Senior Photographer</p>
              
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b></b> <a class="pull-right">{{$photographer->description}}</a>
                </li>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card card-statistics  py-3 tbody-bc">
              ...
              <div class="card-body">
                <form action="{{action('Admin\PhotographyController@service_store')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="id" value="{{$photographer->id}}">
                  <div class="form-group">
                ...
                <tbody>
                  @foreach ($services as $item)
                    <tr>
                        ...
                        @endforeach</td>
                        <td>{{$item->price}}</td>
                        <td><a onclick="return confirm('Are you sure?')" href="{{action('Admin\PhotographyController@service_delete', ['id'=>$item->id])}}" class="btn btn-sm btn-danger">Del</a></td>
                    </tr>
                </tbody>
                  @endforeach
               </table>
