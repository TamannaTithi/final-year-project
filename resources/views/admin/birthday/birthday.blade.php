...
<div class="d-block d-sm-flex flealign-items-center">
                <div class="page-title mb-2 mb-sm-0">
                    <h1 class="mb-2 text-white">Birthday Book</h1>
                </div>
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Birthday Book</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                                ...
                                                <tbody class="tbody-bc">
                                                    ...
                                                    @foreach ($bookbirthday as $item)
                                                     <tr>
                                                       ...
                                                       <td>{{$item->message}}</td>
                                                         <td class="text-right">
                                                        <a onclick="return confirm('Are you sure?')" href="{{action('User\BirthdayBookController@delete',['id'=>$item->id])}}" class="btn btn-sm btn-danger">Del</a>
                                                          </td>
                                                     </tr>
                                                    @endforeach
                                                   </tbody>
